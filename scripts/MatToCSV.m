...
%Version 1.1.2 Last Editied February 12th, 2020
%
...
%   This is true for NLCD, Elevation, and Landscan as well.
%
...
%
%   avhrr_cover_frac_nlcd2006/2001.mat contains land cover codes. The codes are
...
load('data/MATLABFiles/avhrr_cover_frac_nlcd2006.mat') %Land Cover codes. 
load('data/MATLABFiles/avhrr_cover_frac_nlcd2001.mat') %Land Cover codes.
load('data/MATLABFiles/landscan_avhrr_grid_2000_2017.mat') %Landscan
load('data/MATLABFiles/avhrr_1km_pixel_latlon.mat') %lat and long for the pixels
