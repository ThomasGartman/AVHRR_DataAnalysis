...
MapCreator_wrapper<-function(synchronyMatrix,
  ...
  MapCreator(data = synchronyMatrix, fileName = paste(resloc,nametag,"_Synchrony1989to2018.png",sep=""),
             title = paste(nametag, " Synchrony 1989 to 2018, Pearson, r = 5", sep=""),
             legendLabel = "Synchrony", xOffset = xOffset, yOffset = yOffset, numColors = 32, brk = brklist$synchronybreaks)
  ...
  MapCreator(data = landscanMatrix, fileName = paste(resloc,nametag,"_Landscan_Population_2003and2004.png",sep=""), 
             ...
             legendLabel = "Population", xOffset=xOffset,  yOffset = yOffset, numColors = 32, brk = brklist$popbreaks)
  
  MapCreator(data = temporalAverageNDVIMatrix, fileName = paste(resloc,nametag,"_NDVI_TemporalAverage_1989to2018.png",sep=""),
             title = paste(nametag, " NDVI Temporal Average 1989 to 2018", sep=""),
             legendLabel = "Average NDVI", xOffset = xOffset, yOffset = yOffset, numColors = 32, brk = brklist$NDVIbreaks)
  ...
  MapCreator(data = agricultureNLCDMatrix, fileName = paste(resloc,nametag,"_NLCD_Agriculture_Average_2001and2006.png",sep=""),
             ...
             legendLabel = "Percent Ag", xOffset = xOffset, yOffset = yOffset, numColors = 32, brk = brklist$agbreaks)
  ...
  MapCreator(data = developmentMatrix,  fileName = paste(resloc,nametag,"_NLCD_DevelopmentIndex_Average_2001and2006.png",sep=""), 
             ...
             legendLabel = "Index", xOffset = xOffset, yOffset = yOffset, numColors = 32, brk = brklist$devbreaks)
  ...
  MapCreator(data = elevationMatrix, fileName = paste(resloc,nametag,"_Elevation.png",sep=""), 
             ...
             legendLabel = "Meters", xOffset = xOffset, yOffset = yOffset, numColors = 32, brk = brklist$elevationbreaks)
